...
with open('Bankruptcy_prediction.sav', 'rb') as f:
...
def main():
    ...
    if st.button("Predict"):
        ...
        if prediction[0] == 0:
            st.write('As per the financial data provided there is no need of Bankruptcy !!')
        else:
            st.write('As per the financial data provided there is need of Bankruptcy !!')
